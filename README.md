...
| 学习 | `adm_batch_complete_course`, `adm_browse_lesson`, `adm_complete_scorm_section`, `adm_check_in`, `adm_check_in_with_answers`, `adm_check_in_with_rating`, `adm_complete_course`, `adm_enroll_course`, `adm_get_course_structure`, `adm_get_enroll_form`, `adm_get_learning_progress`, `adm_get_lesson_status`, `adm_get_questionnaire_questions`, `adm_resolve_course_url`, `adm_start_exam`, `adm_submit_enroll_form`, `adm_submit_exam`, `adm_submit_exam_with_config`, `adm_submit_questionnaire`, `adm_submit_questionnaire_with_config` |
| 资源（SCORM） | `adm_upload_scorm`, `adm_list_resources`, `adm_rename_resource`, `adm_delete_resource` |
| 资源（文档） | `adm_upload_document`, `adm_list_documents`, `adm_rename_document`, `adm_delete_document`, `adm_upload_documents_batch`, `adm_delete_documents_batch` |
| 资源（音视频） | `adm_upload_audio_video`, `adm_list_audio_videos`, `adm_rename_audio_video`, `adm_delete_audio_video` |
...
| 学习 | `tch_batch_complete_course`, `tch_browse_lesson`, `tch_check_in`, `tch_check_in_with_answers`, `tch_check_in_with_rating`, `tch_complete_course`, `tch_complete_scorm_section`, `tch_enroll_course`, `tch_get_course_structure`, `tch_get_enroll_form`, `tch_get_learning_progress`, `tch_get_lesson_status`, `tch_get_questionnaire_questions`, `tch_resolve_course_url`, `tch_start_exam`, `tch_submit_enroll_form`, `tch_submit_exam`, `tch_submit_exam_with_config`, `tch_submit_questionnaire`, `tch_submit_questionnaire_with_config` |
...
| 课程 | `stu_list_participated_courses`, `stu_get_course_structure`, `stu_get_learning_progress`, `stu_resolve_course_url` |
...
| `delete_learning_program` | teacher | 删除学习项目 |
...
| `delete_learning_program_admin` | admin | 删除学习项目 |
